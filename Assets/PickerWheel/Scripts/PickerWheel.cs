...
namespace EasyUI.PickerWheelUI
{
    ...
    public class PickerWheel : MonoBehaviour
    {
        ...
        [Space]
        [SerializeField] private GameObject linePrefabInvisible;
        [SerializeField] private Transform linesInvisibleParent;
        ...
        public List<Transform> WheelPieceTransforms = new List<Transform>();
        ...
        private void DrawPiece(int index)
        {
            ...
            WheelPieceTransforms.Add(pieceTrns);
            ...
            //Line
            Transform lineTrns;
            if (wheelPieces.Length > 1)
            {
                lineTrns = Instantiate(linePrefab, linesParent.position, Quaternion.identity, linesParent).transform;
            }
            else
            {
                lineTrns = Instantiate(linePrefabInvisible, linesInvisibleParent.position, Quaternion.identity, linesInvisibleParent).transform;
            }
